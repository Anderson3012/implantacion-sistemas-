...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 15-12-2024 a las 17:53:02
...
CREATE TABLE `admin` (
  ...
  `apellido_admin` varchar(80) NOT NULL,
...
CREATE TABLE `consulta` (
  ...
  `fecha_consulta` varchar(11) NOT NULL,
  `hora_consulta` int(8) NOT NULL,
...
CREATE TABLE `metodo_pago` (
  `id_metodopago` int(11) NOT NULL,
  `metodo_pago` enum('Pago movil','Transferencia','Efectivo') NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
...
CREATE TABLE `pago` (
  ...
  `id_psicologa` int(11) NOT NULL,
  `monto_pago` float NOT NULL,
  `fecha_pago` int(16) NOT NULL,
  `numero_consultas` int(80) NOT NULL,
  `id_metodopago` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
...
CREATE TABLE `psicologa` (
  ...
  `tipo_documento` enum('V','E','J') NOT NULL,
  `numero_documento` int(8) NOT NULL,
  `apellido_psicologa` varchar(60) NOT NULL,
  `nombre_psicologa` varchar(60) NOT NULL,
...
CREATE TABLE `tipo_usuario` (
  `id_tipousuario` int(11) NOT NULL,
  `tipo_usario` enum('cliente','psicologa','admin') NOT NULL,
  `status` enum('activo','inactivo') NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
...
ALTER TABLE `factura`
  ...
  ADD KEY `id_metdopago` (`id_metodopago`);
...
--
ALTER TABLE `cliente`
  ADD CONSTRAINT `cliente_ibfk_1` FOREIGN KEY (`id_direccion`) REFERENCES `estados` (`id_estado`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `factura`
  ADD CONSTRAINT `factura_ibfk_1` FOREIGN KEY (`id_metodopago`) REFERENCES `metodo_pago` (`id_metodopago`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `pago`
  ADD CONSTRAINT `pago_ibfk_1` FOREIGN KEY (`id_psicologa`) REFERENCES `psicologa` (`id_psicologa`) ON DELETE CASCADE ON UPDATE CASCADE;
